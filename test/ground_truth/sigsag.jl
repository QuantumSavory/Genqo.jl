# FROZEN v1 code, resurrected verbatim from `src/legacy/sigsag.jl` at commit 8d75cae.
# Do not modify, and do not reuse outside ground-truth generation: this is the
# independent oracle the v2 framework is validated against. See GenqoV1.jl.
